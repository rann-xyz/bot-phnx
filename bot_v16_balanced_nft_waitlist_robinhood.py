"""
🤖 AlphaDrop Bot v16.0 — Fresh-Only + NFT Sources + Persistent Dedup
Changes vs v12:
...
class Fetcher:
    ...
    async def rss_decrypt(self):
        text = await self._get("https://decrypt.co/rss", 20, "text")
        return self._parse_rss(text, "Decrypt")

    async def rss_theblock(self):
        text = await self._get("https://theblock.co/rss", 20, "text")
        return self._parse_rss(text, "TheBlock")

    async def rss_bankless(self):
    ...
    def _source_map(self):
        return {
            ...
            "Decrypt": self.rss_decrypt(), "TheBlock": self.rss_theblock(),
...
class UI:
    ...
    def help_menu(cls):
        embed = discord.Embed(
            title="🤖 AlphaDrop Bot v16.0 — Fresh-Only, Expanded NFT Sources",
            description=(
