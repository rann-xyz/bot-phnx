"""
🤖 AlphaDrop Bot v17.0 — Fresh-Only + NFT Sources + Persistent Dedup
Changes vs v12:
...
class Fetcher:
    ...
    def _source_map(self):
        return {
            "AirdropAlert": self.rss_airdropalert(), "AirdropAlert Blog": self.rss_airdropalert_blog(),
            "CoinMarketCap": self.rss_coinmarketcap(), "Airdrops.io": self.rss_airdrops_io(),
            "DropsEarn": self.rss_dropsearn(), "DropsEarn Testnet": self.rss_dropsearn_testnet(),
            "DropsEarn Waitlist": self.rss_dropsearn_waitlist(), "DropsEarn Retroactive": self.rss_dropsearn_retroactive(),
            "Mirror.xyz": self.rss_mirror_alpha(), "Medium": self.rss_medium_crypto(),
            "Medium Early Crypto": self.rss_medium_early_crypto(), "Medium Ambassador": self.rss_medium_ambassador(),
            "CoinTelegraph": self.rss_cointelegraph(), "CoinDesk": self.rss_coindesk(),
            "AirdropsMob": self.rss_airdropsmob(), "AirdropBob": self.rss_airdropbob(),
            "Bankless": self.rss_bankless(), "Bitcoinist": self.rss_bitcoinist(),
            "NewsBTC": self.rss_newsbtc(), "CryptoPotato": self.rss_cryptopotato(),
            "Blockworks": self.rss_blockworks(), "EarnDrop.io": self.rss_earndrop_io(),
            "Gitcoin Blog": self.rss_gitcoin_blog(), "Layer3 Blog": self.rss_layer3_blog(),
            "Galxe Blog": self.rss_galxe_blog(),
            "NFTCalendar": self.rss_nftcalendar(), "NFTEvening": self.rss_nftevening(),
            "NFTPlazas": self.rss_nftplazas(), "CryptoArt": self.rss_cryptoart(),
            "Medium Retroactive": self.rss_retroactive_hunters(), "Medium DeFi Alpha": self.rss_defi_alpha(),
            "ICODrops": self.rss_icodrops(), "CryptoRank Blog": self.rss_cryptorank_io(),
            "NFT Now": self.rss_nftnow(), "NFT Culture": self.rss_nftculture(),
            "NFT Lately": self.rss_nftlately(), "NFT News Pro": self.rss_nftnewspro(),
            "NFTCalendar Blog": self.rss_nftcalendar_blog(),
            "NFT News": self.rss_nftnews(), "NFT Street": self.rss_nftstreet(),
            "NFT Culture Blog": self.rss_nftculture_blog(),
            "CoinDesk": self.rss_coindesk(), "The Block": self.rss_theblock(),
            "Blockworks": self.rss_blockworks(), "Cointelegraph": self.rss_cointelegraph(),
            "Ethereum Blog": self.rss_ethereum_blog(), "LayerZero": self.rss_layerzero(),
            "zkSync": self.rss_zksync(), "Arbitrum": self.rss_arbitrum(),
            "Solana": self.rss_solana(), "OpenSea": self.rss_opensea(),
            "Rarible": self.rss_rarible(),
            "Product Hunt": self.rss_producthunt(), "Indie Hackers": self.rss_indiehackers(),
            "Alchemy": self.rss_alchemy_blog(),
            "AlphaDrops": self.api_alpha_drops(), "DappRadar": self.dappradar_airdrops(),
            "CryptoRank": self.cryptorank_upcoming(), "DeFiLlama": self.defillama_alpha(),
            "OpenSea": self.nft_opensea_trending(), "Magic Eden": self.magiceden_launchpad(),
            "Snapshot": self.snapshot_spaces(), "RootData": self.rootdata_funding(),
        }
...
class UI:
    ...
    def help_menu(cls):
        embed = discord.Embed(
            title="🤖 AlphaDrop Bot v17.0 — Fresh-Only, Expanded NFT Sources",
            description=(
